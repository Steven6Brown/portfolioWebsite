...
const TAB_DATA = [
    {
        ...
        content: (
            <div>
                ...
                <div className='pl-4'> 
                    <ul className='list-disc'>
                        <li>Highschool Diploma - Mount Pleasant Area Junior Senior High School</li>
                    </ul>
                </div>
            </div>
        )
            ...
            <div>
                ...
                <div className='pl-4'>
                    <ul className='list-disc'>
                        ...
                        <li>AG Parts - South Greensburg, PA</li>
                ...
                <div className='pl-4'>
                    <ul className='list-disc'>
                        <li>Men's Wearhouse - State College, PA</li>
                        <li>The LandTek Group - Long Island, NY</li>
                    </ul>
                </div>
            </div>
        )
    },
    {
        ...
        content: (
            <div>
                <h4 className='font-bold text-white border-b mb-1'>LinkedIn Certificates</h4>
                <div className='pl-4'>
                    <ul className='list-disc'>
                ...
                <h4 className='font-bold text-white border-b mb-1'>Penn State Certificates</h4>
                <div className='pl-4'>
                    <ul className='list-disc'>
        ...
        <section id='about' className='text-white container'>
            <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 '>
                <div className='mt-4 md:mt-0 text-left flex flex-col h-full md:order-2'>
                    <h3 className='text-transparent bg-clip-text bg-gradient-to-r from-p-green to-s-blue mb-2 w-fit'>
                        About Me
                    </h3>
