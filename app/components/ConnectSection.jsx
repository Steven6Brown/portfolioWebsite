...
const ConnectSection = () => {
  ...
  return (
    <section id="contact" className='grid md:grid-cols-2 gap-4 container'> {/* relative */}
        {/* DESIGN IDEA */}
        ...
        <div className='mb-8'>
            ...
            {/* Buttons/Icons */}
            <div className='socials flex flex-row py-2'>
                {/* LinkedIn */}
                ...
                {/* GitHub */}
                <Link href='/githublink'> {/* ADD GITHUB LINK */}
                    <button className='p-4 w-full rounded-full sm:w-fit bg-transparent bg-gradient-to-br from-p-green to-s-blue hover:bg-slate-800 text-black lg:mr-10 shadow-black shadow-lg'> {/* POSSIBLY CHANGE text-black TO text-white */}
                ...
                {/* Discord */}
                <Link href='/discordlink'> {/* ADD DISCORD LINK */}
                    <button className='p-4 w-full rounded-full sm:w-fit bg-transparent bg-gradient-to-br from-p-green to-s-blue hover:bg-slate-800 text-black lg:mr-10 shadow-black shadow-lg'> {/* POSSIBLY CHANGE text-black TO text-white */}
                ...
                <Link href='https://www.instagram.com/stevie6brown/'> {/* ADD INSTAGRAM LINK */}
                    <button className='p-4 w-full rounded-full sm:w-fit bg-transparent bg-gradient-to-br from-p-green to-s-blue hover:bg-slate-800 text-black lg:mr-10 shadow-black shadow-lg'> {/* POSSIBLY CHANGE text-black TO text-white */}
